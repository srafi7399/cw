...
<div itemscope itemtype="http://schema.org/Dataset">				
		<div id = "sexsection" class="panel panel-default">
			...
			<div class="panel-heading">
				<h3 class="panel-title"><span itemprop="about">The ratio of Male to Female population in Pascagoula city</h3>
			</div>
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title"><span itemprop="about">Age details for Pascagoula city  </h3>
			</div>	
...
<div id ="racesection" class="panel panel-default">
			...
			<div class="panel-heading">
				<h3 class="panel-title"><span itemprop="about">Race Data for Pascagoula city </h3>
			</div>
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Total population : <span class="label label-primary">22300</span>	
...
<div id = "hispanicorlatino" class="panel panel-default">
			...
			<div class="panel-heading">
				<h3 class="panel-title"><span itemprop="about">Hispanic or Latino and Race - Pascagoula city</h3>
			</div>
			<div  class="panel-body">
			<div class = "col-xs-12">		
...
<div id = "householdsbytype" class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title"><span itemprop="about">Households by type in <span itemprop="spatial">Pascagoula city </h3>
			</div>			
			<div  class="panel-body">
			<div class = "col-xs-6">		
...
<div id = "relationship" class="panel panel-default">
			...
			<div class="panel-heading">
				<h3 class="panel-title"><span itemprop="about">Relationship in <span itemprop="spatial">Pascagoula city households</h3>
			</div>			
			<div  class="panel-body">
			<div class = "col-xs-12">		
...
<div id = "maritalstatus" class="panel panel-default">
			...
			<div class="panel-heading">
				<h3 class="panel-title"><span itemprop="about">Marital Status in <span itemprop="spatial">Pascagoula city </h3>
			</div>			
			<div  class="panel-body">
			<div class = "col-xs-12">		
...
<div id = "fertility" class="panel panel-default">
			...
			<div class="panel-heading">
				<h3 class="panel-title"><span itemprop="about">Fertility Data for Women in <span itemprop="spatial">Pascagoula city </h3>
			</div>			
			<div  class="panel-body">
			<div class = "col-xs-12">		
...
<div id = "grandparents" class="panel panel-default">
			...
			<div class="panel-heading">
				<h3 class="panel-title"><span itemprop="about">Grandparents responsible for own Grandchildren in <span itemprop="spatial">Pascagoula city </h3>
			</div>			
			<div  class="panel-body">
			<div class = "col-xs-12">		
	...
	<div id = "schoolenrollment" class="panel panel-default">
			...
			<div class="panel-heading">
				<h3 class="panel-title"><span itemprop="about">School Enrollment in <span itemprop="spatial">Pascagoula city </h3>
			</div>			
			<div  class="panel-body">
			<div class = "col-xs-12">		
...
<div id = "educationalatt" class="panel panel-default">
			...
			<div class="panel-heading">
				<h3 class="panel-title"><span itemprop="about">Educational Attainment in <span itemprop="spatial">Pascagoula city </h3>
			</div>			
			<div  class="panel-body">
			<div class = "col-xs-12">		
...
<div id = "veterans" class="panel panel-default">
			...
			<div class="panel-heading">
				<h3 class="panel-title"><span itemprop="about">Veterans Status in <span itemprop="spatial">Pascagoula city </h3>
			</div>			
			<div  class="panel-body">
			<div class = "col-xs-12">		
...
<div id = "birthplace" class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title"><span itemprop="about">Place of Birth data for <span itemprop="spatial">Pascagoula city </h3>
			</div>			
			<div  class="panel-body">
			<div class = "col-xs-6">		
...
<div id = "citizenship" class="panel panel-default">		
			<div class="panel-heading">
				<h3 class="panel-title"><span itemprop="about">U.S Citizenship Status for foreign born population in <span itemprop="spatial">Pascagoula city </h3>
			</div>			
			<div  class="panel-body">
			<div class = "col-xs-12">		
...
<div id = "language" class="panel panel-default">
			...
			<div class="panel-heading">
				<h3 class="panel-title"><span itemprop="about">Language spoken at home in <span itemprop="spatial">Pascagoula city </h3>
			</div>			
			<div  class="panel-body">
			<div class = "col-xs-6">		
...
<div id = "ancestry" class="panel panel-default">
			...
			<div class="panel-heading">
				<h3 class="panel-title"><span itemprop="about">Ancestry Data for population in <span itemprop="spatial">Pascagoula city </h3>
			</div>			
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Total population : <span class="label label-primary">22300</span>		
...
<div id = "computers" class="panel panel-default">
			...
			<div class="panel-heading">
				<h3 class="panel-title"><span itemprop="about">Computers and Internet use in <span itemprop="spatial">Pascagoula city </h3>
			</div>			
			<div  class="panel-body">
			<div class = "col-xs-12">		
